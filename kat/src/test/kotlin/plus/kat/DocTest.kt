...
<content><![CDATA[this is data]]></content>
        ...
        assertEquals(
            """{title=KAT+, link=https://kat.plus/, atom:link={href=https://kat.plus/}, item={id=1, title=<this is 'KAT' & "+">, link=https://kat.plus/MzE.html, view={value=∞, =99+}, author=kraity, content=this is data}}""",
            map.toString()
        )
    }
}
