...
public class Stream extends Binary implements Flux {
    ...
    public interface Bucket {
         ...
         */
        byte[] apply(byte[] flow, int size, int capacity);
    }
    ...
    public static final Bucket BUCKET = new Bucket() {
        ...
        @Override
        public byte[] apply(byte[] flow, int size, int capacity) {
        ...
        escape:
        {
            switch (val) {
                ...
                case 0x7F: {
                    ...
                    it[size++] = '0';
                    it[size++] = '0';
                    it[size++] = UPPER[(val >> 4) & 0x0F];
                    it[size++] = UPPER[val & 0x0F];
                    return;
                }
            }
    ...
    /**
     * Mark cleaned to avoid recycling
     * {@link #value}, handle it yourself
     */
    public Bucket clean() {
        clean = true;
        return bucket;
