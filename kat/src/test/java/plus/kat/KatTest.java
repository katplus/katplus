...
public class KatTest {
    ...
    public void test_encode1() throws IOException {
        try (Chan chan = Kat.encode(
            ...
            assertEquals(
                "\"java.lang.Error: fault\"", chan.toString()
            );
        }
        try (Chan chan = Kat.encode(
            new Throwable("fault")
            ...
            assertEquals(
                "\"java.lang.Throwable: fault\"", chan.toString()
            );
        }
        try (Chan chan = Kat.encode(
            new Exception("fault")
            ...
            assertEquals(
                "\"java.lang.Exception: fault\"", chan.toString()
            );
        }
    }
    ...
    public void test_read1() throws IOException {
        ...
        Model model2 = spare.read(
            Flow.of("{user=\"{id=1,name=kraity}\"}").and(VALUE_AS_BEAN)
        );
