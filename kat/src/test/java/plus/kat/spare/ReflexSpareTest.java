...
public class ReflexSpareTest {
    ...
    @Test
    public void test_with_method_name() {
        Spare<Mate> spare =
            spare(Mate.class);
    ...
    @Test
    public void test_with_name_uppercase() {
        Spare<Meta> spare =
            spare(Meta.class);
    ...
    @Test
    public void test_with_multi_args_and_non_static() {
        A a = Kat.decode(
    ...
    @Test
    public void test_transient_field_and_method() {
        Spare<Bean1> spare =
            spare(Bean1.class);
    ...
    @Test
    public void test_magic_in_constructor() {
        Spare<Modal> spare =
            spare(Modal.class);
