...
public class DocTest {
    ...
    public void test_mark() {
        ...
        assertEquals(
            "<article><author><id>1</id><name>kraity</name><blocked>false</blocked></author><title>mark</title></article>", Doc.encode("article", data)
        );
    }
    ...
    public void test_encode1() {
        ...
        data.put("别名", "陆之岇");
        assertEquals(
            "<Map><别名>陆之岇</别名></Map>", Doc.encode(data)
        );
        assertEquals(
            "<Map><\\u522B\\u540D>\\u9646\\u4E4B\\u5C87</\\u522B\\u540D></Map>", Doc.encode(data, Flag.UNICODE)
        );
    }
}
